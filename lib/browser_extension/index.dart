...
export 'package:bookmarks/browser_extension/fakes/chrome_types_dart.dart'
    if (dart.library.js_interop) 'package:bookmarks/browser_extension/browser_interops/chrome_types.dart';

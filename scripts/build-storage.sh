...
# This example script is used to build the extension implementation of the storage demo. To view mobile, run/build as you normally would while also inlcuding the --target lib/main_storage_demo.dart flag
